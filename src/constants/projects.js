export const projects = {
    cloudengage: {
        ...
        description: ["After completing Epicodus I was brought on originally as an intern at CloudEngage. After working there through the Summer I was selected as one of the interns to be brought on full time. From there I quickly rose amoung the ranks and was given the lead developer role on the company's biggest and newest feature, Chord.", "While working at CloudEngage I was tasked with working on the front and back end of all of the major features, services and products offered. Since it was a pretty small engineering team of only 3-6 engineers, I had the opprtunity to work on all aspects of the platform. My main tasks were handling our Alert feature, Chord Messaging Service, automated email system for various email automation needs, and the billing system through Stripe. Chord, the chat messaging service, was my prime focus which allowed me to gain lots of experience dealing with websockets.", "Due to my work at CloudEngage being proprietary I cannot post any code samples but you can view a demo of CloudEngage below or you can check out the Chord chat service at https://cloudengage.com/platform/chord. "]
    },
    delane: {
